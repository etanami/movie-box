            ...
            <div className=" grid md:grid-cols-3 gap-x-4 border-2 border-gray-300 mt-4 p-4">
              <div className="col-span-2 flex flex-col gap-2 h-auto">
                <div className="flex items-center gap-2 lg:gap-4 text-gray-700 font-bold">
                  <div className="lg:text-xl" data-testid="movie-title">{ details.title }• <span data-testid="movie-release-date">{ details.release_date }</span> • PG-13    <span data-testid="movie-runtime">{ details.runtime }</span></div>
                ...
                <h1 className="mt-3 lg:text-lg" data-testid="movie-overview">{ details.overview }</h1>
                ...
                <div className="border border-gray-200 rounded-xl text-xl">
                  <span className="inline-block p-4 bg-rose-700 text-white text-center py-2 rounded-xl">Top rated movie #65</span>
                  <span className="inline-block px-4">Awards 9 nominations</span>
                </div>
              </div>
              <div className="text-xl">
                ...
                <span className="block bg-rose-700 text-white text-center py-2 rounded-xl">See Showtimes</span>
